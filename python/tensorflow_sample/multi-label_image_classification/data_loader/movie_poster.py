...
# 関数
#---------------------------------
def load_movie_poster(dataset_dir, output_dir='./output', resize=[400, 400], test_data_ratio=0.2, random_seed=-1):
...
#	print(anns)
	...
	print('[INFO] save annotations to {}'.format(os.path.join(output_dir, 'annotations.json')))
