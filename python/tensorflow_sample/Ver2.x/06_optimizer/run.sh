...
OPTIMIZER_LIST=("adam" "sgd" "adam_lrs" "sgd_lrs")
...
# --- Compare models(ALL) ---
metrics_list=\
"${OUTPUT_DIR}/model/${MLP_CIFAR10_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${MLP_CIFAR10_DAFalse}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${MLP_MNIST_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${MLP_MNIST_DAFalse}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DAFalse}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_MNIST_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_MNIST_DAFalse}/metrics/metrics.csv,"\
...
"${OUTPUT_DIR}/model/${SimpleResNet_MNIST_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_MNIST_DAFalse}/metrics/metrics.csv"
metrics_names=\
"${MLP_CIFAR10_DATrue},"\
"${MLP_CIFAR10_DAFalse},"\
"${MLP_MNIST_DATrue},"\
"${MLP_MNIST_DAFalse},"\
"${SimpleCNN_CIFAR10_DATrue},"\
"${SimpleCNN_CIFAR10_DAFalse},"\
"${SimpleCNN_MNIST_DATrue},"\
"${SimpleCNN_MNIST_DAFalse},"\
"${SimpleResNet_CIFAR10_DATrue},"\
"${SimpleResNet_CIFAR10_DAFalse},"\
"${SimpleResNet_MNIST_DATrue},"\
"${SimpleResNet_MNIST_DAFalse}"
...
# --- Compare models(CNN, CIFAR-10, DA-True) ---
metrics_list=\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DATrue_OPTsgd}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DATrue_OPTadamlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DATrue_OPTsgdlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DATrue}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DATrue_OPTsgd}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DATrue_OPTadamlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DATrue_OPTsgdlrs}/metrics/metrics.csv"
metrics_names=\
"${SimpleCNN_CIFAR10_DATrue},"\
"${SimpleCNN_CIFAR10_DATrue_OPTsgd},"\
"${SimpleCNN_CIFAR10_DATrue_OPTadamlrs},"\
"${SimpleCNN_CIFAR10_DATrue_OPTsgdlrs},"\
"${SimpleResNet_CIFAR10_DATrue},"\
"${SimpleResNet_CIFAR10_DATrue_OPTsgd},"\
"${SimpleResNet_CIFAR10_DATrue_OPTadamlrs},"\
"${SimpleResNet_CIFAR10_DATrue_OPTsgdlrs}"
output_dir="${OUTPUT_DIR}/metrics_graph-cnn-cifar10-da_true"

python3 tools/create_metrics_graph/create_metrics_graph.py --metrics_list ${metrics_list} --metrics_names ${metrics_names} --fig_size ${fig_size} --output_dir ${output_dir}

# --- Compare models(CNN, CIFAR-10, DA-False) ---
metrics_list=\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DAFalse}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DAFalse_OPTsgd}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DAFalse_OPTadamlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleCNN_CIFAR10_DAFalse_OPTsgdlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DAFalse}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DAFalse_OPTsgd}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DAFalse_OPTadamlrs}/metrics/metrics.csv,"\
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DAFalse_OPTsgdlrs}/metrics/metrics.csv"
metrics_names=\
"${SimpleCNN_CIFAR10_DAFalse},"\
"${SimpleCNN_CIFAR10_DAFalse_OPTsgd},"\
"${SimpleCNN_CIFAR10_DAFalse_OPTadamlrs},"\
"${SimpleCNN_CIFAR10_DAFalse_OPTsgdlrs},"\
"${SimpleResNet_CIFAR10_DAFalse},"\
"${SimpleResNet_CIFAR10_DAFalse_OPTsgd},"\
"${SimpleResNet_CIFAR10_DAFalse_OPTadamlrs},"\
"${SimpleResNet_CIFAR10_DAFalse_OPTsgdlrs}"
output_dir="${OUTPUT_DIR}/metrics_graph-cnn-cifar10-da_false"
