...
DATA_NORM_LIST=("max" "max-min" "z-score")
					...
					do
						...
						do
							...
							do
								...
								model_dir="${OUTPUT_DIR}/model/${MODEL_TYPE}_${DATA_TYPE}_${DATA_AUG_NAME}_OPT-${OPTIMIZER}_batch${BATCH_SIZE}_${INITIALIZER}_datanorm-${DATA_NORM}"
								mkdir -p ${model_dir}
...
"${OUTPUT_DIR}/model/${SimpleResNet_CIFAR10_DA3_OPTmomentum_he_normal_DNmax}/metrics/metrics.csv,"\
...
"${SimpleResNet_CIFAR10_DA3_OPTmomentum_he_normal_DNmax},"\
